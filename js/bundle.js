...
class Api {
  ...
  getFilmCards() {
    return this._load({url: `movies`})
      .then(Api.toJSON)
			.then((cards) => cards.map(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }

  _getComments(filmCardId) {
    return this._load({url: `comments/${filmCardId}`})
    .then(Api.toJSON)
    .then((comments) => _model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptCommentsToClient(comments));
  }
  ...
  updateFilmCard(card, fallback) {
    return this._load({
      url: `movies/${card.id}`,
      method: Method.PUT,
      body: JSON.stringify(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptCardToServer(card)),
  ...
  addComment(comment) {
    ...
    return this._load({
      url: `comments/${cardId}`,
      method: Method.POST,
      body: JSON.stringify(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptLocalCommentToServer(comment)),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then(Api.toJSON)
      .then(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient)
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: DESCRIPTION_LIMIT, EMOJI_FILE_NAMES, FILM_CARD_AMOUNT_PER_STEP, PROPERTY_STATUS_CHANGED, SortType, UserAction, UpdateType, FilterType, userGradeSettings */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DESCRIPTION_LIMIT", function() { return DESCRIPTION_LIMIT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EMOJI_FILE_NAMES", function() { return EMOJI_FILE_NAMES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FILM_CARD_AMOUNT_PER_STEP", function() { return FILM_CARD_AMOUNT_PER_STEP; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_STATUS_CHANGED", function() { return PROPERTY_STATUS_CHANGED; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "userGradeSettings", function() { return userGradeSettings; });
const DESCRIPTION_LIMIT = 140;
const EMOJI_FILE_NAMES = [`smile`, `sleeping`, `puke`, `angry`];
const FILM_CARD_AMOUNT_PER_STEP = 5;
const PROPERTY_STATUS_CHANGED = `changed`;
...
/* harmony import */ var _view_film_number_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view/film-number.js */ "./src/view/film-number.js");
...
/* harmony import */ var _presenter_filter_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./presenter/filter.js */ "./src/presenter/filter.js");
/* harmony import */ var _presenter_user_profile_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./presenter/user-profile.js */ "./src/presenter/user-profile.js");
/* harmony import */ var _model_movies_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./model/movies.js */ "./src/model/movies.js");
...
const handleStatisticClick = () => {
  if (statisticComponent) {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(statisticComponent);
  }
  movieListPresenter.destroy();
  movieListPresenter.destroySort();
  statisticComponent = new _view_statistics_js__WEBPACK_IMPORTED_MODULE_3__["default"](filmCardsModel.getFilmCards());
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(siteMainElement, statisticComponent, `beforeend`);
};
...
// Models
const filmCardsModel = new _model_movies_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
const filterModel = new _model_filter_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
// View
const userProfilePresenter = new _presenter_user_profile_js__WEBPACK_IMPORTED_MODULE_6__["default"](siteHeaderElement, filmCardsModel);
const filterPresenter = new _presenter_filter_js__WEBPACK_IMPORTED_MODULE_5__["default"](siteMainElement, filterModel, filmCardsModel, handleStatisticClick, handleMenuItemClick);
// Presenter
const movieListPresenter = new _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_4__["default"](siteMainElement, filmCardsModel, filterModel, api);
...
api.getFilmCards()
  ...
  .then((filmCards) => {
    filmCardsModel.setFilmCards(_const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].INIT, filmCards);
    // Render number of films
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(siteFooterStatsElement, new _view_film_number_js__WEBPACK_IMPORTED_MODULE_2__["default"](filmCards), `beforeend`);
    filterPresenter.unlock();
  })
  .catch((err) => {
    window.console.error(err);
    filmCardsModel.setFilmCards(_const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].INIT, []);
  });
...
class Filter extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._currentValue = _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL;
...
class FilmCardPresenter {
  ...
  init(card) {
    ...
    this._filmCardComponent = new _view_film_card_js__WEBPACK_IMPORTED_MODULE_0__["default"](card);
    this._popupComponent = new _view_film_popup_js__WEBPACK_IMPORTED_MODULE_1__["default"](card);
    ...
    if (!prevFilmCardComponent || !prevPopupComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._filmListElement, this._filmCardComponent, `beforeend`);
      return;
    }
  ...
  _toggleProperty(property) {
    ...
    (this._changedProperties[property] === _const_js__WEBPACK_IMPORTED_MODULE_3__["PROPERTY_STATUS_CHANGED"])
      ? null
      : _const_js__WEBPACK_IMPORTED_MODULE_3__["PROPERTY_STATUS_CHANGED"];
  }
  ...
  _closePopup() {
    ...
    if (this._controlFlag) {
      this._changeData(
          _const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].UPDATE_FILM_CARD,
          _const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].PATCH_CUSTOM,
          Object.assign(
              {},
              this._card
          ),
  ...
  _handleWatchlistClick() {
    ...
    this._toggleProperty(_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].WATCHLIST);
  ...
  _handleWatchlistPopupClick() {
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].UPDATE_FILM_CARD,
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].PATCH,
        Object.assign(
            {},
            this._card,
            {
  ...
  _handleHistoryClick() {
    this._setCurrentProperties(this._card);
    this._toggleProperty(_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].HISTORY);
  ...
  _handleFavoriteClick() {
    this._setCurrentProperties(this._card);
    this._toggleProperty(_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].FAVORITES);
...
class Filter {
  ...
  init() {
    ...
    this._view = new _view_site_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters, this._currentValue);
    ...
    if (!prevComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._view, `beforeend`);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._view, prevComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(prevComponent);
  }
  ...
  _handleTypeChange(filterType) {
    ...
    this._model.set(_const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MAJOR, filterType);
  }
  ...
  _getValues() {
    ...
    return [
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ALL,
        name: `All movies`,
        count: _utils_filters_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ALL](filmCards).length
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].WATCHLIST,
        name: `Watchlist`,
        count: _utils_filters_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].WATCHLIST](filmCards).length
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].HISTORY,
        name: `History`,
        count: _utils_filters_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].HISTORY](filmCards).length
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].FAVORITES,
        name: `Favorites`,
        count: _utils_filters_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].FAVORITES](filmCards).length
      },
    ];
  }
}
...
/* harmony import */ var _presenter_film_card_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../presenter/film-card.js */ "./src/presenter/film-card.js");
/* harmony import */ var _view_film_board_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/film-board.js */ "./src/view/film-board.js");
/* harmony import */ var _view_load_more_button_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/load-more-button.js */ "./src/view/load-more-button.js");
/* harmony import */ var _view_no_films_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/no-films.js */ "./src/view/no-films.js");
/* harmony import */ var _view_film_sorting_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/film-sorting.js */ "./src/view/film-sorting.js");
...
/* harmony import */ var _utils_film_cards_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/film-cards.js */ "./src/utils/film-cards.js");
/* harmony import */ var _utils_filters_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/filters.js */ "./src/utils/filters.js");
...
class MovieList {
  constructor(boardContainer, filmCardsModel, filterModel, api) {
    ...
    this._renderedFilmCards = _const_js__WEBPACK_IMPORTED_MODULE_7__["FILM_CARD_AMOUNT_PER_STEP"];
    ...
    this._filmBoardComponent = new _view_film_board_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._noFilmsComponent = new _view_no_films_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
  ...
  _getFilmCards() {
    ...
    const filteredCards = _utils_filters_js__WEBPACK_IMPORTED_MODULE_9__["filter"][filterType](filmCards);

    switch (this._currentSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["SortType"].DATE:
        return filteredCards.sort(_utils_film_cards_js__WEBPACK_IMPORTED_MODULE_8__["sortByDate"]);
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["SortType"].RATING:
        return filteredCards.sort(_utils_film_cards_js__WEBPACK_IMPORTED_MODULE_8__["sortByRating"]);
    }
  ...
  _renderCard(container, card) {
    const filmCardPresenter = new _presenter_film_card_js__WEBPACK_IMPORTED_MODULE_0__["default"](container, this._handleViewAction, this._handleModeChange);
  ...
  _renderCardsList(incomeCards) {
    ...
    const filmCards = incomeCards ? incomeCards
      : this._getFilmCards()
        .slice(0, Math.min(filmCardsCount, _const_js__WEBPACK_IMPORTED_MODULE_7__["FILM_CARD_AMOUNT_PER_STEP"]));
  ...
  _renderLoadMoreButton() {
    ...
    this._loadMoreButtonComponent = new _view_load_more_button_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._loadMoreButtonComponent.setHandler((evt) => {
      evt.preventDefault();
      this._handleLoadMoreButtonClick();
    });

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._filmListElement.parentElement, this._loadMoreButtonComponent, `beforeend`);
  }

  _renderNoFilms() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._filmListElement, this._noFilmsComponent, `beforeend`);
  }

  _renderLoading() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._filmListElement, this._loadingComponent, `beforeend`);
  }

  _renderSort() {
    const prevSortingComponent = this._filmSortingComponent;

    this._filmSortingComponent = new _view_film_sorting_js__WEBPACK_IMPORTED_MODULE_4__["default"](this._currentSortType);
    this._filmSortingComponent.setSortTypeChangeHandler(this._handleSortTypeChange);

    if (prevSortingComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["replace"])(this._filmSortingComponent, prevSortingComponent);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["remove"])(prevSortingComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._boardContainer, this._filmSortingComponent, `beforeend`); // Render sorting block
    }
  }

  destroySort() {
    if (this._filmSortingComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._filmSortingComponent);
      this._filmSortingComponent = null;
    }
  }
  ...
  _prepareEmptyBoard() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._boardContainer, this._filmBoardComponent, `beforeend`);
  ...
  _clearBoard({resetRenderedFilmCardsCount = false, resetSortType = false} = {}) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._filmBoardComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._noFilmsComponent);
  ...
  _handleLoadMoreButtonClick() {
    const filmCardsCount = this._getFilmCards().length;
    const newRenderedFilmCardsCount = Math.min(filmCardsCount, this._renderedFilmCards + _const_js__WEBPACK_IMPORTED_MODULE_7__["FILM_CARD_AMOUNT_PER_STEP"]);
    const filmCards = this._getFilmCards().slice(this._renderedFilmCards, newRenderedFilmCardsCount);

    this._renderCards(filmCards);
    this._renderedFilmCards += _const_js__WEBPACK_IMPORTED_MODULE_7__["FILM_CARD_AMOUNT_PER_STEP"]; // Rendered cards + rendered after click
  ...
  _handleViewAction(actionType, updateType, update, property) {
    ...
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["UserAction"].UPDATE_FILM_CARD:
        this._api.updateFilmCard(update, ...fallback)
          .then((updatedCard) => {
            this._filmCardsModel.updateFilmCard(updateType, updatedCard);
          });
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["UserAction"].ADD_COMMENT:
        this._filmCardPresenterObserver[clearId].setViewState(_presenter_film_card_js__WEBPACK_IMPORTED_MODULE_0__["State"].SAVING);
        this._api.addComment(update)
          .then((updatedCard) => {
            this._filmCardsModel.updateFilmCard(updateType, updatedCard);
          })
          .catch(() => {
            this._filmCardPresenterObserver[clearId].setViewState(_presenter_film_card_js__WEBPACK_IMPORTED_MODULE_0__["State"].ABORTING, deletedCommentId, actionType);
          });
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["UserAction"].DELETE_COMMENT:
        this._filmCardPresenterObserver[clearId].setViewState(_presenter_film_card_js__WEBPACK_IMPORTED_MODULE_0__["State"].DELETING, deletedCommentId, actionType);
  ...
  _handleModelEvent(updateType, update) {
    ...
    switch (updateType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].PATCH:
        ...
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].PATCH_CUSTOM:
        const filterType = this._filterModel.get();
        if (this._cardPropertyChanged[filterType] === _const_js__WEBPACK_IMPORTED_MODULE_7__["PROPERTY_STATUS_CHANGED"]) {
          // MINOR update
          this._clearBoard();
          this._renderBoard();
        } else {
...
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _utils_user_profile_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/user-profile.js */ "./src/utils/user-profile.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
class UserProfilePresenter {
  ...
  init() {
    this._activeRank = Object(_utils_user_profile_js__WEBPACK_IMPORTED_MODULE_2__["getUserRank"])(this._filmCardsModel.getFilmCards(), _const_js__WEBPACK_IMPORTED_MODULE_3__["userGradeSettings"]);

    const prevUserProfileComponent = this._userProfileComponent;

    this._userProfileComponent = new _view_user_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._activeRank);
    ...
    if (prevUserProfileComponent) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._userProfileComponent, `beforeend`);
    }
  }
...
/*!*********************************!*\
  !*** ./src/utils/film-cards.js ***!
  \*********************************/
/*! exports provided: formatYear, shortenString, sortByDate, sortByRating, formatDate, formatDuration */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatYear", function() { return formatYear; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "shortenString", function() { return shortenString; });
...
const formatDuration = (duration) => {
  const momentDuration = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration, `minutes`);
...
const filter = {
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL]: (filmCards) => filmCards,
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST]: (filmCards) => filmCards.filter((filmCard) => filmCard.isListed),
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].HISTORY]: (filmCards) => filmCards.filter((filmCard) => filmCard.isWatched),
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES]: (filmCards) => filmCards.filter((filmCard) => filmCard.isFavorite),
};
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: render, createElement, remove, replace */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!*********************************!*\
  !*** ./src/utils/statistics.js ***!
  \*********************************/
/*! exports provided: countWatchedFilms, countDuration, findTopGenre, countWatchedInPeriod */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "countWatchedFilms", function() { return countWatchedFilms; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "countDuration", function() { return countDuration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "findTopGenre", function() { return findTopGenre; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "countWatchedInPeriod", function() { return countWatchedInPeriod; });
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);
...
const periodToFilterMap = {
  ...
  [`today`]: (cards) => cards.filter((card) => moment__WEBPACK_IMPORTED_MODULE_0___default()(card.watchingDate).isBetween(moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf(`day`), moment__WEBPACK_IMPORTED_MODULE_0___default()().endOf(`day`))),
  [`week`]: (cards) => cards.filter((card) => moment__WEBPACK_IMPORTED_MODULE_0___default()(card.watchingDate).isBetween(moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf(`week`), moment__WEBPACK_IMPORTED_MODULE_0___default()().endOf(`week`))),
  [`month`]: (cards) => cards.filter((card) => moment__WEBPACK_IMPORTED_MODULE_0___default()(card.watchingDate).isBetween(moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf(`month`), moment__WEBPACK_IMPORTED_MODULE_0___default()().endOf(`month`))),
  [`year`]: (cards) => cards.filter((card) => moment__WEBPACK_IMPORTED_MODULE_0___default()(card.watchingDate).isBetween(moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf(`year`), moment__WEBPACK_IMPORTED_MODULE_0___default()().endOf(`year`)))
};

const countWatchedFilms = (filmCards) => {
  return (filmCards.length !== 0) ? filmCards.filter((card) => card.isWatched) : 0;
};

const countDuration = (filmCards) => {
  const totalDuration = filmCards.reduce((acc, current) => acc + current.duration, 0);
  const momentTotal = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(totalDuration, `minutes`);
...
const countWatchedInPeriod = (filmCardsAndPeriod) => {
...
const getUserRank = (filmCards, userProfileData) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmBoard; });
...
class FilmBoard extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _utils_film_cards_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/film-cards.js */ "./src/utils/film-cards.js");
...
const createFilmCardTemplate = (filmCard) => {
  ...
  const releaseYear = Object(_utils_film_cards_js__WEBPACK_IMPORTED_MODULE_1__["formatYear"])(release);
  const formattedDuration = Object(_utils_film_cards_js__WEBPACK_IMPORTED_MODULE_1__["formatDuration"])(duration);
  const firstGenre = genres[0];
  const commentsAmount = comments.length;
  const shortDescription = Object(_utils_film_cards_js__WEBPACK_IMPORTED_MODULE_1__["shortenString"])(description, _const_js__WEBPACK_IMPORTED_MODULE_0__["DESCRIPTION_LIMIT"]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmNumber; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
...
class FilmNumber extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
const createCommentTemplate = (comments, deletedCommentId) => {
  ...
  return comments.map(({id, text, emoji, author, date}) => {
    const commentDate = Object(_utils_film_cards_js__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(date, `YYYY/MM/DD HH:mm`);
    const emojiTemplate = emoji ? `<img src="./images/emoji/${emoji}.png" width="55" height="55" alt="${emoji}"/>` : ``;
    const encodedText = he__WEBPACK_IMPORTED_MODULE_3___default.a.encode(text);
...
const createFilmDescriptionInList = (filmCard) => {
  ...
  const longReleaseDate = Object(_utils_film_cards_js__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(release, `DD MMMM YYYY`);
  const formattedDuration = Object(_utils_film_cards_js__WEBPACK_IMPORTED_MODULE_1__["formatDuration"])(duration);
    ...
    <div class="form-details__bottom-container">
      <section class="film-details__comments-wrap">
        ...
        <div class="film-details__new-comment">
          ...
          ${createEmojiList(_const_js__WEBPACK_IMPORTED_MODULE_0__["EMOJI_FILE_NAMES"], newEmojiName)}
          </div>
        </div>
      </section>
    </div>
...
class FilmDetails extends _smart_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  shake(callback, actionType, deletedCommentId) {
    let targetElement;
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_0__["UserAction"].ADD_COMMENT:
        targetElement = this.getElement().querySelector(`.film-details__new-comment`);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_0__["UserAction"].DELETE_COMMENT:
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmSorting; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
const createFilmSortingTemplate = (currentSortType) => {
  const sortingList = Object.values(_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"]).map((type) => {
...
class FilmSorting extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony import */ var _utils_user_profile_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/user-profile.js */ "./src/utils/user-profile.js");
...
const renderChart = (statisticCtx, filmCardsAndPeriod) => {
  const watchedInPeriod = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["countWatchedInPeriod"])(filmCardsAndPeriod);

  const genresMap = watchedInPeriod ? Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["findTopGenre"])(watchedInPeriod) : false;
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(statisticCtx, {
...
const createStatisticsTemplate = (filmCardsAndPeriod) => {
  ...
  const totalDuration = watchedAmount ? Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["countDuration"])(watchedInPeriod) : 0;
  const hours = totalDuration.hours ? totalDuration.hours : 0;
  const minutes = totalDuration.minutes ? totalDuration.minutes : 0;
  const topGenre = watchedAmount ? Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["findTopGenre"])(watchedInPeriod)[0][0] : ``;

  const userRank = Object(_utils_user_profile_js__WEBPACK_IMPORTED_MODULE_5__["getUserRank"])(filmCardsAndPeriod.cards, _const_js__WEBPACK_IMPORTED_MODULE_4__["userGradeSettings"]);
